 ...
 * @author RA21507734
 */
public class buscarClientePorNome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           for(Cliente c:resultado){
               out.println("Clientes encontrados");
               out.println("nome:" + c.getNome());
               out.println("cpf: " + c.getCpf());
               out.println ("endereco: " + c.getEndereco());
               out.println("<br/");
           } 
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet buscarClientePorNome at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
